...
void display(void)
{
  ...
  glColor3f(1.0,1.0,1.0);
  glBegin(GL_LINE_STRIP);
  glVertex3f(11.6,-0.2,-15);
  glVertex3f(12,-0.6,-15);
  glEnd();

  glColor3f(1.0,1.0,1.0);
  glBegin(GL_LINE_STRIP);
  glVertex3f(11.6,-0.6,-15);
  glVertex3f(12,-0.2,-15);
  glEnd();

  ///draw y-axis label
  glColor3f(1.0,1.0,1.0);
  glBegin(GL_LINE_STRIP);
  glVertex3f(-0.6,12,-15);
  glVertex3f(-0.35,11.7,-15);
  glEnd();

  glColor3f(1.0,1.0,1.0);
  glBegin(GL_LINE_STRIP);
  glVertex3f(-0.2,12,-15);
  glVertex3f(-0.6,11.4,-15);
  glEnd();
